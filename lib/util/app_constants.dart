...
class AppConstants {
  static const String appName = 'Amigo Delivery';
  static const double appVersion = 8.0;

  static const String fontFamily = 'Alexandria';
  static const bool payInWevView = false;
  static const String webHostedUrl = 'https://stadesdz.site';
  static const bool useReactWebsite = false;

  static const String baseUrl = 'https://stadesdz.site';
  ...
  static List<LanguageModel> languages = [
    LanguageModel(imageUrl: Images.france, languageName: 'Francais', countryCode: 'FR', languageCode: 'fr'),
    LanguageModel(imageUrl: Images.tunisie, languageName: 'عربى', countryCode: 'TN', languageCode: 'ar'),
  ];
